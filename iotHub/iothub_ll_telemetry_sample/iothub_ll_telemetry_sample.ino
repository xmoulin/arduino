...
#include <stdio.h>
#include <stdlib.h>
#define ARDUINO_ARCH_ESP8266 true
...
#define MESSAGE_COUNT 2 // determines the number of times the device tries to send a message to the IoT Hub in the cloud.
...
const char* telemetry_msg = "test_message2";
...
{
    LogInfo("**** receive_message_callback - begin \r\n");
...
{
    LogInfo("**** send_confirm_callback - begin \r\n");
...
{
    LogInfo("**** connection_status_callback - begin \r\n");
    (void)reason;
    (void)user_context;
    ...
    else
    {
        ...
        do
        {
            if (messages_sent < MESSAGE_COUNT)
            {
                ...
                (void)IoTHubMessage_SetProperty(message_handle, "switchStatus", "up");
