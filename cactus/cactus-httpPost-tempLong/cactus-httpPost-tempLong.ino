...
#define PORT         "1880"
#define PIECE        "salon"  //salon


//period between posts, set at 30 minutes
const unsigned long DELAY_PERIOD=1800000;
...
//INIT CONNEXION
    ...
    Serial.println("debug Xav"); 
    Serial.println(ret); 
    Serial.println("Fin debug Xav"); 
...
//        data = data+"21&humidity=51&topic=/sensors/chambre";
        Serial.print("data=");
        Serial.println(data);
