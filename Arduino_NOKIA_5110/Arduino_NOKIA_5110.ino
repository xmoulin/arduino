...
void LcdInitialise(void)
{
  ...
  LcdWrite(LCD_C, 0x21 );  // LCD Extended Commands. XMO:33
  LcdWrite(LCD_C, 0xAA );  // Set LCD Vop (Contrast). XMO:177 
  LcdWrite(LCD_C, 0x04 );  // Set Temp coefficent. //0x04 XMO:4
  LcdWrite(LCD_C, 0x14 );  // LCD bias mode 1:48. //0x13 XMO:20
